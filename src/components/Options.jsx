...
function Options() {
    ...
    return (
        ...
        <div class="grid grid-rows-2 grid-flow-col gap-4 py-4 text-xl justify-center">
            <div class="flex justify-center">
                <label class="px-4">
                    <text>No. of Questions:   </text>
                    <select
                        class="bg-gray-50 border border-stone-400 text-gray-900 text-sm rounded-lg focus:ring-amber-700 focus:border-amber-700 w-auto p-2"
            ...
            <div class="flex justify-center">
                <button class="bg-orange-300 hover:bg-orange-500 text-orange-900 font-semibold hover:text-white py-2 px-4 border border-stone-400 hover:border-transparent rounded"
